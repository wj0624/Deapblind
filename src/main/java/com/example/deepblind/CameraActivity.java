...
public class CameraActivity extends AppCompatActivity implements OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.cam_txt);
        ...
        try {
            ...
            tts.speak("촬영에 실패했습니다. 다시 시도해주세요", TextToSpeech.QUEUE_FLUSH, null, null);
        }
    ...
    private class ImageUploaderTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String result = "글자 인식에 실패했습니다. 다시 촬영해주세요.";
...
//                else {
//                    result = "글자 인식에 실패했습니다. 다시 촬영해주세요.";
//                }
